...
```bash
# Setup (one-time)
nix run github:ToxicPine/ambit/chromatic -- setup

# Create a browser
nix run github:ToxicPine/ambit/chromatic -- create my-browser

# Configure MCP to use it
nix run github:ToxicPine/ambit/chromatic -- mcp my-browser
```
